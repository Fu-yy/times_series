...
class Exp_My_Forecast(Exp_Basic):
    def __init__(self, args):
        super(Exp_My_Forecast, self).__init__(args)
    ...
    def train(self, setting):
        ...
        #
        #     print(i)
        #     print(i, batch_x, batch_y, batch_x_mark)
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.use_amp:
                    ...
                    f_dim = -1 if self.args.features == 'MS' else 0
                    outputs = outputs[:, -self.args.pred_len:, f_dim:]  # 32*7*12

                    batch_y = batch_y[:, -self.args.pred_len:, f_dim:].to(self.device)  # 32*96*7
